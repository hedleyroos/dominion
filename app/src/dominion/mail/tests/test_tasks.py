...
from dominion.mail.tasks import send_mail, send_unsent_mails, vacuum
...
@override_settings(EMAIL_BACKEND="dominion.mail.backends.CeleryLocMemBackend")
...
class SendUnsentMailsTaskTestCase(TestCase):
    def test_sends_all_unsent_messages(self):
        ...
        with patch("dominion.mail.tasks.send_mail") as mock_task:
